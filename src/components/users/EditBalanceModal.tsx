...
const EditBalanceModal: FC<IEditCode> = ({ user }) => {
      ...
      case 1:
        return (
            <div className='flex flex-col gap-5 items-center w-[600px] text-dark-1'>
              <h4 className='text-white uppercase text-3xl font-medium'>EDIT BALANCE</h4>
              <UserAvatarWithName
                user={user}
              ...
              <div className='flex gap-7 items-center'>
                <div className='flex flex-col gap-2 p-7 bg-dark-1c'>
                  ...
                  <div className='text-gray-7 text-base'>Current Balance</div>
                </div>
                ...
                <div className='flex flex-col gap-2 p-7 bg-dark-1c'>
                  ...
                  <div className='text-gray-7 text-base'>New Balance</div>
                </div>
              </div>
